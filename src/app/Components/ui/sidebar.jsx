...
export const SidebarProvider = forwardRef(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
...
export const SidebarMenuAction = forwardRef(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  const Comp = asChild ? Slot : "button";
  return (
    <Comp
      ref={ref}
      ...
      className={cn(
        "absolute right-3 top-3.5 flex items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2",
...
export const SidebarMenuBadge = forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
...
export const SidebarMenuSkeleton = forwardRef(({ className, showIcon = false, ...props }, ref) => {
...
export const SidebarMenuSubItem = forwardRef(({ ...props }, ref) => <li ref={ref} {...props} />);
